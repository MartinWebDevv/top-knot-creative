...
export default function About() {
  return (
    <section
      id="about"
      style={{ padding: "5rem 1.5rem", background: "#F3EDE5" }}
    >
      <div
        style={{
          maxWidth: 1100,
      ...
      >
        ...
        <Reveal delay={0.15}>
          ...
          >
            Based in Las Vegas, I've spent the past year helping local business
            owners look their best online. My clients are small shop owners —
            real people who need a real web presence without the agency price
            tag.
          </p>
          <p
            style={{
          ...
          >
            I handle everything from design and development to launch and
