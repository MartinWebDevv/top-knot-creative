...
export default function About() {
  return (
    <section id="about" style={{ padding: '8rem 2.5rem', background: '#F3EDE5' }}>
      <div style={{ maxWidth: 1100, margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '5rem', alignItems: 'center' }}>
        ...
        <Reveal delay={0.15}>
          ...
          <h2 style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: 'clamp(2rem, 3vw, 3rem)', fontWeight: 600, lineHeight: 1.15, marginBottom: '1.5rem' }}>
